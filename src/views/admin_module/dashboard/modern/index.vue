         ...
         <v-col cols="12">
           <v-row>
                <v-col cols="12" lg="8" md="7">
                    <v-card elevation="10" >
                        <v-card-text>
                            <h2 class="v-card-title text-h5">Yearly Earning</h2>
                            <ApexColumnChart/>
                        </v-card-text>
                    </v-card>
                </v-col>
                            ...
                            <div class="px-6 pt-6 pb-3">
                                <v-row class="align-center">
                                    <v-col cols="auto" class="me-auto">
                                        <h2 class="v-card-title text-h5 pa-0">Notice Board</h2>
                                    </v-col>
                                    <v-col cols="auto">
                                        <div class="">
                                            <router-link to="#" class="pa-2 bg-primary text-white rounded-md" color="primary" variant="flat">View</router-link>
                                        </div>
                                    </v-col>
                                </v-row>
                            </div>
                            <perfect-scrollbar style="height:400px">
                                <v-list class="py-0 theme-list" lines="two">
                                    <v-list-item v-for="item in notifications" :key="item.title" :value="item" active-color="primary" class="py-4 px-8">
                                        ...
                                        <template v-slot:prepend>
                                            <v-avatar size="48" class="align-start mr-3">
                                                    <img src="@/assets/images/sju/sju-dummy.jpg" width="48" alt="avatar" />
                                            </v-avatar>
                                        </template>
                                        <div>
