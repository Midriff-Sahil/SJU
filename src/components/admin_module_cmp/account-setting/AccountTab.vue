...
/*personal detail*/
const firstName = ref('Mathew');
const lastName = ref('Anderson');
const userEmail = ref('admission@stjosephuniversity.edu.dm');
const userPhone = ref('+1(767)2651011');
                ...
                <v-card elevation="10">
                    <v-card-item>
                        ...
                        <div class="text-center mt-6 mb-6">
                            <v-avatar size="120">
                                <img src="@/assets/images/profile/user-9.jpg" height="120" alt="image" />
                            </v-avatar>
                        </div>
